# The Bound — the code walk

*The culminating chapter of Vol 4 · Scientific Computation. The one bound rendered as a walk through the actual
Lean: run it yourself. Pairs with `vol4_spec.md`.*
