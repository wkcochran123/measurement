...
\noindent A single observation proves little; a lone reading is an anecdote, as apt to be error as fact. Weight
comes from repetition --- the same measurement taken again and again until the scatter of any one trial averages
away and a stable shape stands out that no single reading could show. An account carries no weight from one
telling but from the pattern many independent tellings settle into: what persists across the repetitions is the
evidence; what belonged to a single trial washes out. Which measurements to gather, and how to bin them, is
ours; the shape the many settle into, and how fast the noise falls as they accumulate, is the world's.
