...
The records are not just a list; they carry an algebra. Relations among entries compose and invert, channels
...
the relations the record already holds. The reading is that relations form an algebra. The order and exclusion
...
independent product. A library makes the point plainly --- the content of a book is independent of the shelf it
...
coordinates that vary freely of each other.

The honest floor is a finite count obligation --- the information axis and the spacetime axis are independent
coordinates, their joint count the product of their separate counts. The reading is that information is an axis
of its own, independent of where and when. Strip the geometric connotation from ``orthogonal'': the content of
a reading is not perpendicular to spacetime in any spatial sense but independent of it, free to take any value
...
unchanged. On Christmas Eve of 1906, Reginald Fessenden put his own voice and a violin over the radio, where
...
however the symbols are chosen. Channel capacity is exactly this admissible decomposition --- not how fast a
...
its count, and capacity is the count of admissible symbols. The reading is that a channel is a decomposition,
...
across the dependencies at once. The dependent effects are not signals; they are recalculations.

The honest floor is a finite count obligation --- the recalculation is additive under append, restoring global
coherence by a count, not a propagation. The reading is that coherence is recomputed, not propagated. A change
...
one repairable. Coarsening the record preserves the count; the correction restores it.

The honest floor is a finite count obligation --- interleaving and parity are count-preserving operations that
recover the recorded count across a gap. The reading is that error correction is a record that protects its own
...
With error correction, the chapter closes, and its claim is whole: the records form an algebra, closed under
...
entries the record already holds rather than an addition to them. Part VI turns next to computation itself ---
