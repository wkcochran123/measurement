...
This is the chapter the whole book has been built to reach. Through four parts the finite model has stood
...
genuinely registers, by a logic the model proves. The positron --- the electron's antiparticle, equal in mass
and opposite in charge, the partner the Dirac equation's negative-energy solutions predicted a chapter ago ---
is the book's exemplar, the place where the model proves the most, and, not by accident, the place where it
fences the most clearly. The two go together: the firmer the claim, the sharper the line around it must be
drawn. Two effects carry the chapter: the annihilation by which a positron is detected, and the threshold at
...
straight line through the point where they were born.
...
apparatus is silent. The registration is the conjunction, and the conjunction is checkable term by term.
...
charge-cancellation it carries from its foundation: that the electron and positron readings cancel, and that a
positron is what an asymmetric baseline yields. This is the strongest grounding in the book.

And it is the most careful. The honest floor is a finite count obligation, the most fully proved in the book,
...
in the book is also its clearest fence.
...
the annihilation must have lain. Millions of such lines, intersected, reconstruct a three-dimensional map of
...
This is the negative-energy picture of the last chapter run forward. The Dirac equation's solutions came in two
...
energy it costs: the gap across the sea, twice the rest mass. The chirality and the Dirac operator of the
previous chapter described the electron's two-signed dynamics; here the second sign is paid for and walks out
...
The crossing is not merely a change in a count; it is a change in the sign of the strain's second variation,
...
bracket the crossing falls, the apparatus cannot say --- but absent any structure its readings do not supply,
...
\end{equation}
inside $(0, 1]$ and assuming nothing the readings do not give.
...
With the positron, the book reaches its deepest grounding. Through naming, counting, analogy, and no-go the
...
name a phenomenon, but registers a particle by a proved logic --- while stating, with the same precision,
exactly what it does not claim. That double discipline, to prove all it can and fence all it cannot, is the
book's method in miniature, and the positron is where it shows clearest. Part IV closes next with decay,
