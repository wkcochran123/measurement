...
finite records without showing that those records approach every continuum
...
alone, supply the space in which density is measured, nor does it show that its
...
granted. It does not by itself show that such a completed placement has been
constructed.
...
boundary-radiation theorem. It has established the conditional shape that any such
...
\section*{Coda: At the Door in Review}
