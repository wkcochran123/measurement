...
\section*{Coda: The Shape the Bench Was Making}

Chapter 18 turned the apparatus outward for the first time in the whole book and read what the boundary handed back. It set a finite balance at the edge, shaped like the law that holds a geometry against stress; it showed the difference across that balance exact, down to a single second-order remainder; it named the shape of the residue the balance leaves; it read the leftover the only way the outside allows, as one mark; and it said what that reading was --- received, not taken, the first fact in the book the apparatus does not own. That is the chapter in review. But the part it set down this time does not lie quiet beside the others, and the coda will not pretend it does.
