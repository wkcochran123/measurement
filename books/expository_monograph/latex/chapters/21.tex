...
but reading: taking the quantities the construction produced and saying, plainly, what physics reads them as. The
dictionary sets the machine's built and proved quantities in one column and their physical names
in the other, and does one disciplined thing throughout: it grades every entry as a reading, a name laid
...
The physics the machine speaks is read off the count: each physical quantity the instrument reports is a name
laid over a thing the construction already built or proved.
...
That is a strong claim and the dictionary makes it as a reading, deliberately, because it is exactly the kind of
claim that would be ruinous to overstate. The construction does not prove that all of physics reduces to the count; it
...
always, to the reader. The physics is read off the count. That the count is the physics, the
