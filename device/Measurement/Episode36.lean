  ...
  | some cell =>
      ...
      some
        ({ targetForce := targetForce
           ...
           midpointDistanceScaledAt18 := midpointDistance.scaledFloor (readoutScale)
           lowerG := lowerG
           upperG := upperG
           midpointG := midpointG
           exactRecoveredG := exactG
           originalDeviceG := deviceG
           lowerGScaledAt18 := lowerG.scaledFloor (readoutScale)
           upperGScaledAt18 := upperG.scaledFloor (readoutScale)
           midpointGScaledAt18 := midpointG.scaledFloor (readoutScale)
           exactRecoveredGScaledAt18 := exactG.scaledFloor (readoutScale)
           originalDeviceGScaledAt18 := deviceG.scaledFloor (readoutScale)
