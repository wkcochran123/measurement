...
_This is a gentle reminder that the stories we tell ourselves depend more heavily on the dictionary *YOU the KNOWER* uses than *YOU the READER* expects._
...
__EPISODE 12__: _THE DEMONSTRATION OF IMPOSSIBILITY_
