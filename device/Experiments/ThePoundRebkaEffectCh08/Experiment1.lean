...
namespace Experiments.ThePoundRebkaEffectCh08
...
Variant preserved: duplicate redshift smooth-shadow text from chapter 08.
-/
...
end Experiments.ThePoundRebkaEffectCh08
