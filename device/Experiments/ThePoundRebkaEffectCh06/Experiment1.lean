...
namespace Experiments.ThePoundRebkaEffectCh06

/-
Source description: The Pound-Rebka Effect
Claim ceiling: smoothShadowAnalogy.
The model records a GR/smooth-shadow boundary reading; it is not a QED replication or a proof of the physical spacetime theorem.
Boundary note: this is a General Relativity / smooth-shadow result and is not replicated in QED.
Variant preserved: duplicate redshift smooth-shadow text from chapter 06.
-/
...
def defaultSetup : Setup :=
  { recorded := 2, accessible := 1, required := 3 }
...
end Experiments.ThePoundRebkaEffectCh06
