import Experiments.TheStrongInteractionEffect.Experiment1

namespace Experiments.TheStrongInteractionEffect
...
theorem claimStatement_holds_as_label_only (setup : Setup) :
...
end Experiments.TheStrongInteractionEffect
