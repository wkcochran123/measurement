...
namespace Experiments.TheWhiteHoleEffect

/-
Source description: The White Hole Effect
...
Variant preserved: source boundary condition, not a solved spacetime model.
-/
...
end Experiments.TheWhiteHoleEffect
