...
%
%10. The theorem phenomenon is being replaced by phenom. When asked to write a
%    phenomenon, use the phenom environment, not theorem.
%
...
\newcommand{\Refine}{\mathcal{R}}       % Refinement
...
\newcommand{\Boundary}[2]{\partial(#1,#2)}
...
% Usage: \propproof{universe-tensor}
