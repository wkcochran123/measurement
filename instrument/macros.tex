...
\newcommand{\citeph}[1]{%
  Phenomenon~\ref{ph:#1}%
  \footnote{\csname ph@title@#1\endcsname}%
}

\newcommand{\phenomtitle}[2]{%
  \label{ph:#2}%
  \expandafter\gdef\csname ph@title@#2\endcsname{#1}%
}
...
\newenvironment{phenomk}[2]{%
  \gdef\csname ph@title@#2\endcsname{#1}%
  \begin{phenom}{#1}\label{ph:#2}%
}{%
  \end{phenom}%
}
