...
counts the same rotations and displays a numeral drawn from a finite alphabet.
...
The Berkeley--Galileo Effect names the discipline required to resist this
...
This is the point at which the Hume Effect enters. No finite collection of
